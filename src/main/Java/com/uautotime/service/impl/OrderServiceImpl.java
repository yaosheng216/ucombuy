...
import com.uautotime.dao.*;
import com.uautotime.pojo.*;
import com.uautotime.service.IOrderService;
import com.uautotime.util.BigDecimalUtil;
import com.uautotime.util.DateTimeUtil;
import com.uautotime.util.FTPUtil;
import com.uautotime.util.PropertiesUtil;
import com.uautotime.vo.OrderItemVo;
import com.uautotime.vo.OrderProductVo;
import com.uautotime.vo.OrderVo;
import com.uautotime.vo.ShippingVo;
...
public class OrderServiceImpl implements IOrderService {
    ...
    public ServerResponse pay(Long orderNo, Integer userId, String path) {
        ...
        String subject = new StringBuilder().append("优品购扫码支付，订单号：").append(outTradeNo).toString();
    ...
    public ServerResponse aliCallback(Map<String,String> params){
        ...
        if(order == null){
            return ServerResponse.creatByErrorMessage("非优品购商城的订单，回调忽略");
        }
        if(order.getStatus() >= Const.OrderStatusEnum.PAID.getCode()){
            return ServerResponse.creatBySuccess("支付宝重复回调");
        }
    ...
    public void closeOrder(int hour) {
        ...
        for(Order order : orderList){
            ...
            for(OrderItem orderItem : orderItemList){
                //一定要使用主键where条件，防止锁表，同时必须是支持MySQL的InnoDB存储引擎
